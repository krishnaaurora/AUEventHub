  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Dean Approved EVENT</h1>
          <p className="text-sm text-slate-500 mt-1">EVENT that have been approved by the Dean</p>
        </div>
      ...
      {filteredEvents.length === 0 ? (
        <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="text-slate-500 font-medium">{searchTerm ? 'No events match your search' : 'No events approved by the dean'}</p>
        </div>
      ) : (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {/* Approval/Rejection tools can be kept if VC can also act on them early, but here we can just leave it as viewing or acting */}
                  <button
